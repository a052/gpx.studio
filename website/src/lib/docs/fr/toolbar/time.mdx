...
**Effacer les données temporelles** supprime tous les horodatages de la sélection, y compris ceux du fichier et des points d'intérêt lorsqu'un fichier entier est sélectionné.
