...
**Effacer les données temporelles** supprime tous les horodatages de la sélection, y compris ceux du fichier et des points de passage lorsqu'un fichier entier est sélectionné.
