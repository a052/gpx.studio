...
Lors de l'extraction des pistes d'un fichier contenant des <a href="../gpx">points de passage</a>, l'outil assigne automatiquement chaque point de passage à la piste de laquelle il est le plus proche.
