...
**Effacer les données d'altitude** supprime toutes les données d'altitude de la sélection, y compris celles des points d'intérêt lorsqu'un fichier entier est sélectionné.
