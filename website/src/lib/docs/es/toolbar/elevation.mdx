...
**Borrar datos de desnivel** elimina todos los datos de desnivel de la selección, incluidos los de los puntos de interés cuando se selecciona un archivo completo.
