...
**Borrar datos de tiempo** elimina todas las marcas de tiempo de la selección, incluidas las del archivo y las de los puntos de interés cuando se selecciona un archivo completo.
