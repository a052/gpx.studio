...
En los niveles de zoom más altos, cada punto de la ruta se convierte en un punto de anclaje.
...
<DocsImage src="tools/routing" alt="Los puntos de anclaje le permiten editar una ruta fácilmente." />
