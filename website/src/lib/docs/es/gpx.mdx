...
Consiste esencialmente en una serie de puntos GPS que codifican uno o varios trazados GPS y, opcionalmente, algunos puntos de ruta.
...
### <MapPin size="16" class="inline-block" style="margin-bottom: 2px" /> Puntos de ruta

**Puntos de ruta** representan ubicaciones de interés para mostrar en un dispositivo GPS o en un mapa digital.

Además de sus coordenadas, un punto de ruta puede tener un **nombre** y una **descripción**.
