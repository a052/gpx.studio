...
Además, la vista de árbol de archivos le permite inspeccionar [pistas, segmentos y puntos de ruta](../gpx) contenidos dentro de los archivos a través de secciones plegables.
