...
Beim Extrahieren der Tracks aus einer Datei mit <a href="../gpx">Wegpunkten</a> wird das Werkzeug automatisch jeden Wegpunkt dem Track zuordnen, dem er am nächsten ist.
