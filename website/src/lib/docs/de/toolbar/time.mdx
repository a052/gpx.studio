...
**Zeitdaten löschen** entfernt alle Zeitstempel aus der Auswahl, einschließlich der Zeitstempel der Datei und der Points of Interest, wenn eine ganze Datei ausgewählt ist.
