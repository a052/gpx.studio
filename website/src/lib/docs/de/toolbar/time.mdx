...
**Zeitdaten löschen** entfernt alle Zeitstempel aus der Auswahl, einschließlich der Zeitstempel der Datei und der Wegpunkte, wenn eine ganze Datei ausgewählt ist.
