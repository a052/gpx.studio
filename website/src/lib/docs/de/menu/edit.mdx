...
Wenn das vertikale Layout der Dateiliste aktiviert ist (siehe [Dateien und Statistik](../files-and-stats)), können dieses auch auf [Tracks, Segmente und Wegpunkte](../gpx) angewendet werden.
