...
It essentially consists of a series of GPS points encoding one or multiple GPS traces, and, optionally, some waypoints.
...
### <MapPin size="16" class="inline-block" style="margin-bottom: 2px" /> Waypoints

**Waypoints** represent locations of interest to show either on a GPS device or on a digital map.

In addition to its coordinates, a waypoint can have a **name** and a **description**.
